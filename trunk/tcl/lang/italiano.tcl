...
::menu::mc::GameNewShuffle			"Nuova Partita: &Mischiata"
...
::menu::mc::AllScidBases			"Tutti i Database Scid"
::menu::mc::ScidbBases				"Database Scidb"
::menu::mc::Scid4Bases				"Database Scid 4"
::menu::mc::Scid3Bases				"Database Scid 3"
...
::load::mc::StartupFinished		"Startup completato" ;#NEW "Startup finished"

::load::mc::ECOFile					"File ECO"
::load::mc::EngineFile				"File motore"
::load::mc::SpellcheckFile			"File dizionario"
...
### application::board #################################################
::application::board::mc::AutoPlayMoves		"Usa Autoplay"
...
::application::pgn::mc::NarrowLines							"Linee sottili"
#::application::pgn::mc::IndentVariations					"Indenta varianti"
#::application::pgn::mc::IndentComments					"Indenta commenti"
::application::pgn::mc::BoldTextForMainlineMoves		"Grassetto per mosse nella linea principale"
#::application::pgn::mc::SpaceAfterMoveNumbers			"Spazio dopo il numero di mossa"
...
::playertable::mc::OpenInWebBrowser			"Apri nel browser..."
::playertable::mc::OpenPlayerCard			"Apri profilo utente %s"
::playertable::mc::OpenFileCard				"Apri profilo file %s"
::playertable::mc::OpenFideRatingHistory	"Apri storia punteggio FIDE"
::playertable::mc::OpenWikipedia				"Apri biografia Wikipedia"
...
::browser::mc::GameDataCorrupted	"Dati partita corrotti."
...
::setup::board::mc::Chess960Position			"Posizione Scacchi 960"
::setup::board::mc::SymmChess960Position		"Posizione Scacchi 960 Simmetrica"
::setup::board::mc::ShuffleChessPosition		"Posizione Scacchi Shuffle"
...
::export::mc::Options						"&Opzioni"
::export::mc::PageSetup						"Set&up pagina"
::export::mc::Style							"Sti&le"
::export::mc::Encoding						"&Codifica"
::export::mc::AddGamesToExisitingFile	"&Aggiungi partite a un file esistente"
...
::export::mc::OverwriteDatabase			"Stai per sovrascrivere il dabatase originale %s. Sei sicuro?"
...
::export::mc::Option(pgn,add_country_after_player)				"Aggiungi nazione dopo nome giocatore"
...
### game ###############################################################
::game::mc::Overwrite "La partita %s è stata modificata.\n\nVuoi davvero continuare ed eliminare i cambiamenti effettuati?"
::game::mc::CloseAllGames "Chiudere tutte le partite aperte del database '%s'?\n%s"
::game::mc::DetachAllOpenGames "Tutte le partite ancora aperte saranno slegate dalla dipendenza col loro database."
...
::crosstable::mc::CannotOpenScript	"Non posso aprire lo script '%s'."
...
### fsbox ##############################################################
::dialog::fsbox::mc::Add					"&Aggiungi"
::dialog::fsbox::mc::Cancel				"A&nnulla"
::dialog::fsbox::mc::Directory			"&Cartella:"
::dialog::fsbox::mc::Filename				"Nom&e file:"
::dialog::fsbox::mc::Filenames			"Nom&i file:"
::dialog::fsbox::mc::FilesType			"File del &tipo:"
::dialog::fsbox::mc::Ok						"&Ok"
::dialog::fsbox::mc::Open					"A&pri"
::dialog::fsbox::mc::Remove				"&Rimuovi"
::dialog::fsbox::mc::Save					"&Salva"
::dialog::fsbox::mc::Selection			"Sele&ziona:"
::dialog::fsbox::mc::ShowHiddenDirs		"Mostra carte&lle nascoste"
::dialog::fsbox::mc::ShowHiddenFiles	"Mostra &file e cartelle nascoste"

::dialog::fsbox::mc::ChooseDirectory	"Scegli cartella"
::dialog::fsbox::mc::CreateFolder		"Crea cartella"
::dialog::fsbox::mc::Desktop				"Desktop"
::dialog::fsbox::mc::FileSystem			"File System"
::dialog::fsbox::mc::Folder				"Cartella:"
::dialog::fsbox::mc::HomeFolder			"Cartella Home"
::dialog::fsbox::mc::TitleOpen			"Apri"
::dialog::fsbox::mc::TitleSaveAs			"Salva con nome"

::dialog::fsbox::mc::AddFolder			"Aggiungere cartella '%s' ai preferiti"
::dialog::fsbox::mc::CannotChangeDir	"Non posso cambiare la cartella a \"%s\".\nPermesso negato."
::dialog::fsbox::mc::CannotCreate		"Non è stato possibile creare la cartella \"%s\". Permesso negato."
::dialog::fsbox::mc::DirDoesNotExist	"La cartella \"%s\" non esiste."
::dialog::fsbox::mc::DirectoryRemoved	"Non posso passare alla cartella \"%s\".\nLa cartella è rimossa."
::dialog::fsbox::mc::FileAlreadyExists	"Il file \"%s\" esiste già.\nVuoi sovrascriverlo?"
::dialog::fsbox::mc::FileDoesNotExist	"Il file \"%s\" non esiste."
::dialog::fsbox::mc::FileExists			"La cartella \"%s\" non è potuta essere creata. Non è vuota."
::dialog::fsbox::mc::GotoParentDir		"Vai a cartella precedente"
::dialog::fsbox::mc::InvalidDirectory	"La cartellay \"%s\" non esiste. Aprirla comunque?"
::dialog::fsbox::mc::InvalidFilename	"Nome file non valido \"%s\"."
::dialog::fsbox::mc::InvalidFileExt		"Estensione file non valida \"%s\"."
::dialog::fsbox::mc::RemoveBookmark		"Rimuovi il segnalibro '%s'"
::dialog::fsbox::mc::SelectWhichType	"Selezione che tipo di file visualizzare"
...
### NAG's ##############################################################
::annotation::mc::Nag(0)	"nessun commento"
::annotation::mc::Nag(1)	"mossa buona"
::annotation::mc::Nag(2)	"mossa debole"
::annotation::mc::Nag(3)	"mossa ottima"
::annotation::mc::Nag(4)	"mossa pessima"
::annotation::mc::Nag(5)	"mossa interessante"
::annotation::mc::Nag(6)	"mossa dubbia"
::annotation::mc::Nag(7)	"mossa forzata (tutte le altre perdono velocemente)"
::annotation::mc::Nag(8)	"mossa unica (nessuna alternativa ragionevole)"
::annotation::mc::Nag(9)	"la mossa peggiore"
::annotation::mc::Nag(10)	"posizione patta"
::annotation::mc::Nag(11)	"uguali possibilità, posizione calma"
::annotation::mc::Nag(12)	"uguali possibilità, posizione dinamica"
::annotation::mc::Nag(13)	"posizione complessa"
::annotation::mc::Nag(14)	"il Bianco ha leggero vantaggio"
::annotation::mc::Nag(15)	"il Nero ha leggero vantaggio"
::annotation::mc::Nag(16)	"il Bianco ha netto vantaggio"
::annotation::mc::Nag(17)	"il Nero ha netto vantaggio"
::annotation::mc::Nag(18)	"il Bianco ha un vantaggio decisivo"
::annotation::mc::Nag(19)	"il Nero ha un vantaggio decisivo"
::annotation::mc::Nag(20)	"il Bianco ha un vantaggio schiacciante (il Nero dovrebbe abbandonare)"
::annotation::mc::Nag(21)	"il Nero ha un vantaggio schiacciante (il Bianco dovrebbe abbandonare)"
::annotation::mc::Nag(22)	"il Bianco è in zugzwang"
::annotation::mc::Nag(23)	"il Nero è in zugzwang"
::annotation::mc::Nag(24)	"il Bianco ha un leggero vantaggio di spazio"
::annotation::mc::Nag(25)	"il Nero ha un leggero vantaggio di spazio"
::annotation::mc::Nag(26)	"il Bianco ha un netto vantaggio di spazio"
::annotation::mc::Nag(27)	"il Nero ha un netto vantaggio di spazio"
::annotation::mc::Nag(28)	"il Bianco ha un vantaggio decisivo di spazio"
::annotation::mc::Nag(29)	"il Nero ha un vantaggio decisivo di spazio"
::annotation::mc::Nag(30)	"il Bianco ha un leggero vantaggio di sviluppo"
::annotation::mc::Nag(31)	"il Nero ha un leggero vantaggio di siluppo"
::annotation::mc::Nag(32)	"il Bianco ha un netto vantaggio di sviluppo"
::annotation::mc::Nag(33)	"il Nero ha un netto vantaggio di sviluppo"
::annotation::mc::Nag(34)	"il Bianco ha un vantaggio decisivo di sviluppo"
::annotation::mc::Nag(35)	"il Nero ha un vantaggio decisivo di sviluppo"
::annotation::mc::Nag(36)	"il Bianco ha l'iniziativa"
::annotation::mc::Nag(37)	"il Nero ha l'iniziativa"
::annotation::mc::Nag(38)	"il Bianco ha un'iniziativa duratura"
::annotation::mc::Nag(39)	"il Nero ha un'iniziativa duratura"
::annotation::mc::Nag(40)	"il Bianco ha l'attacco"
::annotation::mc::Nag(41)	"il Nero ha l'attacco"
::annotation::mc::Nag(42)	"il Bianco ha compenso insufficiente per lo svantaggio materiale"
::annotation::mc::Nag(43)	"il Nero ha compenso insufficiente per lo svantaggio materiale"
::annotation::mc::Nag(44)	"il Bianco ha compenso sufficiente per lo svantaggio materiale"
::annotation::mc::Nag(45)	"il Nero ha compenso sufficiente per lo svantaggio materiale"
::annotation::mc::Nag(46)	"il Bianco ha compenso più che adeguato per lo svantaggio materiale"
::annotation::mc::Nag(47)	"il Nero ha compenso più che adeguato per lo svantaggio materiale"
::annotation::mc::Nag(48)	"il Bianco ha un leggero vantaggio al centro"
::annotation::mc::Nag(49)	"il Nero ha un leggero vantaggio al centro"
::annotation::mc::Nag(50)	"il Bianco ha un netto vantaggio al centro"
::annotation::mc::Nag(51)	"il Nero ha un netto vantaggio al centro"
::annotation::mc::Nag(52)	"il Bianco ha un vantaggio decisivo al centro"
::annotation::mc::Nag(53)	"il Nero ha un vantaggio decisivo al centro"
::annotation::mc::Nag(54)	"il Bianco ha un leggero vantaggio sul lato di re"
::annotation::mc::Nag(55)	"il Nero ha un leggero vantaggio sul lato di re"
::annotation::mc::Nag(56)	"il Bianco ha un netto vantaggio sul lato di re"
::annotation::mc::Nag(57)	"il Nero ha un netto vantaggio sul lato di re"
::annotation::mc::Nag(58)	"il Bianco ha un vantaggio decisivo sul lato di re"
::annotation::mc::Nag(59)	"il Nero ha un vantaggio decisivo sul lato di re"
::annotation::mc::Nag(60)	"il Bianco ha un leggero vantaggio sul lato di donna"
::annotation::mc::Nag(61)	"il Nero ha un leggero vantaggio sul lato di donna"
::annotation::mc::Nag(62)	"il Bianco ha un netto vantaggio sul lato di donna"
::annotation::mc::Nag(63)	"il Nero ha un netto vantaggio sul lato di donna"
::annotation::mc::Nag(64)	"il Bianco ha un vantaggio decisivo sul lato di donna"
::annotation::mc::Nag(65)	"il Nero ha un vantaggio decisivo sul lato di donna"
::annotation::mc::Nag(66)	"il Bianco ha la prima traversa vulnerabile"
::annotation::mc::Nag(67)	"il Nero ha la prima traversa vulnerabile"
::annotation::mc::Nag(68)	"il Bianco ha la prima traversa ben protetta"
::annotation::mc::Nag(69)	"il Nero ha la prima traversa ben protetta"
::annotation::mc::Nag(70)	"il Bianco ha un re poco protetto"
::annotation::mc::Nag(71)	"il Nero ha un re poco protetto"
::annotation::mc::Nag(72)	"il Bianco ha un re ben protetto"
::annotation::mc::Nag(73)	"il Nero ha un re ben protetto"
::annotation::mc::Nag(74)	"il Bianco ha un re mal piazzato"
::annotation::mc::Nag(75)	"il Nero ha un re mal piazzato"
::annotation::mc::Nag(76)	"il Bianco ha un re ben piazzato"
::annotation::mc::Nag(77)	"il Nero ha un re ben piazzato"
::annotation::mc::Nag(78)	"il Bianco ha una struttura pedonale molto debole"
::annotation::mc::Nag(79)	"il Nero ha una struttura pedonale molto debole"
::annotation::mc::Nag(80)	"il Bianco ha una struttura pedonale debole"
::annotation::mc::Nag(81)	"il Nero ha una struttura pedonale debole"
::annotation::mc::Nag(82)	"il Bianco ha una struttura pedonale forte"
::annotation::mc::Nag(83)	"il Nero ha una struttura pedonale forte"
::annotation::mc::Nag(84)	"il Bianco ha una struttura pedonale molto forte"
::annotation::mc::Nag(85)	"il Nero ha una struttura pedonale molto forte"
::annotation::mc::Nag(86)	"il Bianco ha un cavallo mal piazzato"
::annotation::mc::Nag(87)	"il Nero ha un cavallo mal piazzato"
::annotation::mc::Nag(88)	"il Bianco ha un cavallo ben piazzato"
::annotation::mc::Nag(89)	"il Nero ha un cavallo ben piazzato"
::annotation::mc::Nag(90)	"il Bianco ha un alfiere mal piazzato"
::annotation::mc::Nag(91)	"il Nero ha un alfiere mal piazzato"
::annotation::mc::Nag(92)	"il Bianco ha un alfiere ben piazzato"
::annotation::mc::Nag(93)	"il Nero ha un alfiere ben piazzato"
::annotation::mc::Nag(94)	"il Bianco ha una torre mal piazzata"
::annotation::mc::Nag(95)	"il Nero ha una torre mal piazzata"
::annotation::mc::Nag(96)	"il Bianco ha una torre ben piazzata"
::annotation::mc::Nag(97)	"il Nero ha una torre ben piazzata"
::annotation::mc::Nag(98)	"il Bianco ha una donna mal piazzata"
::annotation::mc::Nag(99)	"il Nero ha una donna mal piazzata"
::annotation::mc::Nag(100)	"il Bianco ha una donna ben piazzata"
::annotation::mc::Nag(101)	"il Nero ha una donna ben piazzata"
::annotation::mc::Nag(102)	"il Bianco ha una cattiva coordinazione di pezzi"
::annotation::mc::Nag(103)	"il Nero ha una cattiva coordinazione di pezzi"
::annotation::mc::Nag(104)	"il Bianco ha una buona coordinazione di pezzi"
::annotation::mc::Nag(105)	"il Nero ha una buona coordinazione di pezzi"
::annotation::mc::Nag(106)	"il Bianco ha giocato l'apertura molto male"
::annotation::mc::Nag(107)	"il Nero ha giocato l'apertura molto male"
::annotation::mc::Nag(108)	"il Bianco ha giocato male l'apertura"
::annotation::mc::Nag(109)	"il Nero ha giocato male l'apertura"
::annotation::mc::Nag(110)	"il Bianco ha giocato bene l'apertura"
::annotation::mc::Nag(111)	"il Nero ha giocato bene l'apertura"
::annotation::mc::Nag(112)	"il Bianco ha giocato l'apertura molto bene"
::annotation::mc::Nag(113)	"il Nero ha giocato l'apertura molto bene"
::annotation::mc::Nag(114)	"il Bianco ha giocato il mediogioco molto male"
::annotation::mc::Nag(115)	"il Nero ha giocato il mediogioco molto male"
::annotation::mc::Nag(116)	"il Bianco ha giocato male il mediogioco"
::annotation::mc::Nag(117)	"il Nero ha giocato male il mediogioco"
::annotation::mc::Nag(118)	"il Bianco ha giocato bene il mediogioco"
::annotation::mc::Nag(119)	"il Nero ha giocato bene il mediogioco"
::annotation::mc::Nag(120)	"il Bianco ha giocato il mediogioco molto bene"
::annotation::mc::Nag(121)	"il Nero ha giocato il mediogioco molto bene"
::annotation::mc::Nag(122)	"il Bianco ha giocato il finale molto male"
::annotation::mc::Nag(123)	"il Nero ha giocato il finale molto male"
::annotation::mc::Nag(124)	"il Bianco ha giocato male il finale"
::annotation::mc::Nag(125)	"il Nero ha giocato male il finale"
::annotation::mc::Nag(126)	"il Bianco ha giocato bene il finale"
::annotation::mc::Nag(127)	"il Nero ha giocato bene il finale"
::annotation::mc::Nag(128)	"il Bianco ha giocato il finale molto bene"
::annotation::mc::Nag(129)	"il Nero ha giocato il finale molto bene"
::annotation::mc::Nag(130)	"il Bianco ha leggero controgioco"
::annotation::mc::Nag(131)	"il Nero ha leggero controgioco"
::annotation::mc::Nag(132)	"il Bianco ha buon controgioco"
::annotation::mc::Nag(133)	"il Nero ha buon controgioco"
::annotation::mc::Nag(134)	"il Bianco ha un controgioco decisivo"
::annotation::mc::Nag(135)	"il Nero ha un controgioco decisivo"
::annotation::mc::Nag(136)	"il Bianco è in leggero zeitnot"
::annotation::mc::Nag(137)	"il Nero è in leggero zeitnot"
::annotation::mc::Nag(138)	"il Bianco è in netto zeitnot"
::annotation::mc::Nag(139)	"il Nero è in netto zeitnot"
::annotation::mc::Nag(140)	"con idea"
::annotation::mc::Nag(141)	"pensata contro"
::annotation::mc::Nag(142)	"meglio è"
::annotation::mc::Nag(143)	"peggiore è"
::annotation::mc::Nag(144)	"uguale è"
::annotation::mc::Nag(145)	"nota del commentatore"
::annotation::mc::Nag(146)	"Novità"
::annotation::mc::Nag(147)	"Punto debole"
::annotation::mc::Nag(148)	"Finale"
::annotation::mc::Nag(149)	"Linea"
::annotation::mc::Nag(150)	"Diagonale"
::annotation::mc::Nag(151)	"il Bianco ha la coppia degli Alfieri"
::annotation::mc::Nag(152)	"il Nero ha la coppia degli Alfieri"
::annotation::mc::Nag(153)	"Alfieri del colore opposto"
::annotation::mc::Nag(154)	"Alfieri dello stesso colore"
::annotation::mc::Nag(155)	"Diagramma"
::annotation::mc::Nag(156)	"Diagramma dalla prospettiva del nero"
::annotation::mc::Nag(157)	"pedoni isolati"
::annotation::mc::Nag(158)	"pedoni doppiati"
::annotation::mc::Nag(159)	"pedoni connessi"
::annotation::mc::Nag(160)	"pedone passato"
::annotation::mc::Nag(161)	"pedoni sospesi"
::annotation::mc::Nag(162)	"pedone arretrato"
::annotation::mc::Nag(163)	"più pedoni"
::annotation::mc::Nag(164)	"più spazio"
::annotation::mc::Nag(165)	"con"
::annotation::mc::Nag(166)	"senza"
::annotation::mc::Nag(167)	"centro"
::annotation::mc::Nag(168)	"colonna"
::annotation::mc::Nag(169)	"traversa"
::annotation::mc::Nag(170)	"vedi"
::annotation::mc::Nag(171)	"Diverse alternative"
::annotation::mc::Nag(172)	"ecc."
::annotation::mc::Nag(173)	"Space"
::annotation::mc::Nag(174)	"Zeitnot"
::annotation::mc::Nag(175)	"Development"
::annotation::mc::Nag(176)	"Zugzwang"
::annotation::mc::Nag(177)	"limite di tempo"
::annotation::mc::Nag(178)	"Attacco"
::annotation::mc::Nag(179)	"Iniziativa"
::annotation::mc::Nag(180)	"Controgioco"
::annotation::mc::Nag(181)	"Con compenso per il materiale"
::annotation::mc::Nag(182)	"Coppia degli alfieri"
::annotation::mc::Nag(183)	"lato di re"
::annotation::mc::Nag(184)	"lato di donna"
