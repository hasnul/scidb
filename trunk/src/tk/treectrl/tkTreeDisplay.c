 ...
 *
 * RCS: @(#) $Id: tkTreeDisplay.c,v 1.91 2009/05/17 23:27:49 treectrl Exp $
 */
	...
	)
{
	...
	if (	tree->itemHeight <= 0 &&
				...
				(tree->fullStripes != 1 || tree->tailHeight <= 0)) {
		return 0;
	}
...
/*						XSetClipOrigin(tree->display, tree->copyGC, 0, 0);*/
	...
	/* HACK (gc) */
	tree->tailHeight = dInfo->itemHeight;
