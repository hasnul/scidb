...
#ifndef _sci_v91_decoder_position_included
#define _sci_v91_decoder_position_included
...
template <>
struct is_pod<db::sci::v91::decoder::Position::Lookup> { enum { value = is_pod<db::Board>::value }; };

} // namespace mstl

#include "sci_v91_decoder_position.ipp"

#endif // _sci_v91_decoder_position_included
