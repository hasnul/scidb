...
#ifndef _sci_v93_decoder_position_included
#define _sci_v93_decoder_position_included
...
public:
	...
	void setup(uint16_t idn, variant::Type variant);
...
template <>
struct is_pod<db::sci::v93::decoder::Position::Lookup> { enum { value = is_pod<db::Board>::value }; };

} // namespace mstl

#include "sci_v93_decoder_position.ipp"

#endif // _sci_v93_decoder_position_included
