...
MODULE_SCOPE void Tree_ResetColumns(TreeCtrl *tree);
...
MODULE_SCOPE int Tree_IsSteadyColumn(TreeColumn column);
...
MODULE_SCOPE void TreeDragImage_Draw(TreeDragImage dragImage_, TreeDrawable td);
