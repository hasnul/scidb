...
{
    Tcl_PkgProvide(interp, "tkpanedwindow", "1.0");
    ::tcl::createCommand(interp, "::tk::panedwindow", Tk_PanedWindowObjCmd);
}

#else // if !(TK_MAJOR_VERSION <= 8 && TK_MINOR_VERSION <= 6)
...
#endif // TK_MAJOR_VERSION <= 8 && TK_MINOR_VERSION <= 6
// vi:set ts=8 sw=4:
