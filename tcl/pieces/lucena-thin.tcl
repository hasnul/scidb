...
lappend board_PieceSet { Lucena-Thin truetype {stroke {2 0}} {contour 40} {sampling 100} {overstroke 5} }

set truetype_Lucena_Thin(wk) {
<g
  scidb:bbox="88.2,67,812.7,933">
  <path
...
set truetype_Lucena_Thin(wq) {
<g
  scidb:bbox="49.4,67,841.5,933">
  <path
    transform="scale(0.9,1.0)"
    style="fill:black;stroke:none;fill-rule:evenodd"
...
set truetype_Lucena_Thin(wr) {
<g
  scidb:bbox="89.1,67,810.9,933">
  <path
    transform="scale(0.9,1.0)"
    style="fill:black;stroke:none;fill-rule:evenodd"
...
set truetype_Lucena_Thin(wb) {
<g
  scidb:bbox="89.1,67,811.8,933">
  <path
    transform="scale(0.9,1.0)"
    style="fill:black;stroke:none;fill-rule:evenodd"
...
set truetype_Lucena_Thin(wn) {
<g
  scidb:bbox="89.1,67,810,946">
  <path
    transform="scale(0.9,1.0)"
    style="fill:black;stroke:none;fill-rule:evenodd"
...
set truetype_Lucena_Thin(wp) {
<g
  scidb:bbox="89.1,67,811.8,884">
  scidb:scale="0.9">
  <path
    transform="scale(0.9,1.0)"
    style="fill:black;stroke:none;fill-rule:evenodd"
...
set truetype_Lucena_Thin(bq) {
<g
  scidb:bbox="59.4,67,841.5,933">
  <path
    transform="scale(0.9,1.0)"
    style="fill:black;stroke:none;fill-rule:evenodd"
...
set truetype_Lucena_Thin(br) {
<g
  scidb:bbox="89.1,67,812.7,933">
  <path
    transform="scale(0.9,1.0)"
    style="fill:black;stroke:none;fill-rule:evenodd"
...
set truetype_Lucena_Thin(wk,mask) {
<g>
  <path
    transform="scale(0.9,1.0)"
...
set truetype_Lucena_Thin(wq,mask) {
<g>
  <path
    transform="scale(0.9,1.0)"
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(wr,mask) {
<g>
  <path
    transform="scale(0.9,1.0)"
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(wb,mask) {
<g>
  <path
    transform="scale(0.9,1.0)"
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(wn,mask) {
<g>
  <path
    transform="scale(0.9,1.0)"
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(wp,mask) {
<g>
  <path
    scidb:scale="0.9"
    transform="scale(0.9,1.0)"
...
set truetype_Lucena_Thin(bk,mask) $truetype_Lucena_Thin(wk,mask)
set truetype_Lucena_Thin(bq,mask) $truetype_Lucena_Thin(wq,mask)
set truetype_Lucena_Thin(br,mask) $truetype_Lucena_Thin(wr,mask)
set truetype_Lucena_Thin(bb,mask) $truetype_Lucena_Thin(wb,mask)

set truetype_Lucena_Thin(bn,mask) {
<g>
  <path
    transform="scale(0.9,1.0)"
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(bp,mask) $truetype_Lucena_Thin(wp,mask)

set truetype_Lucena_Thin(wk,exterior) {
<g
  transform="scale(0.9,1.0)">
  <path
...
set truetype_Lucena_Thin(wq,exterior) {
<g
  transform="scale(0.9,1.0)">
  <path
...
set truetype_Lucena_Thin(wr,exterior) {
<g
  transform="scale(0.9,1.0)">
  <path
...
set truetype_Lucena_Thin(wb,exterior) {
<g
  transform="scale(0.9,1.0)">
  <path
...
set truetype_Lucena_Thin(wn,exterior) {
<g
  transform="scale(0.9,1.0)">
  <path
...
set truetype_Lucena_Thin(wp,exterior) {
<g
  transform="scale(0.9,1.0)">
  <path
...
set truetype_Lucena_Thin(bk,exterior) $truetype_Lucena_Thin(bk,mask)
set truetype_Lucena_Thin(bq,exterior) $truetype_Lucena_Thin(bq,mask)
set truetype_Lucena_Thin(br,exterior) $truetype_Lucena_Thin(br,mask)
set truetype_Lucena_Thin(bb,exterior) $truetype_Lucena_Thin(bb,mask)
set truetype_Lucena_Thin(bn,exterior) $truetype_Lucena_Thin(bn,mask)
set truetype_Lucena_Thin(bp,exterior) $truetype_Lucena_Thin(bp,mask)

set truetype_Lucena_Thin(bk,interior) {
<g
  transform="scale(0.9,1.0)">
  <path
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(bq,interior) {
<g
  transform="scale(0.9,1.0)">
  <path
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(br,interior) {
<g
  transform="scale(0.9,1.0)">
  <path
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(bb,interior) {
<g
  transform="scale(0.9,1.0)">
  <path
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(bn,interior) {
<g
  transform="scale(0.9,1.0)">
  <path
...
set truetype_Lucena_Thin(bp,interior) {
<g
  transform="scale(0.9,1.0)">
  <path
    style="fill:white;stroke:none"
...
set truetype_Lucena_Thin(sample,24pt,200x34) {
  
